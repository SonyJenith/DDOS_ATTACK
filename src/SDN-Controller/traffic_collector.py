...
class CollectTrainingStatsApp(switch.SimpleSwitch13):
    def __init__(self, *args, **kwargs):
        ...
        file0 = open("/media/sf_Sony-ML/DDoS-Attack-Detection-and-Mitigation/Codes/controller/FlowStatsfile.csv","w")
    ...
    def _flow_stats_reply_handler(self, ev):
        ...
        file0 = open("/media/sf_Sony-ML/DDoS-Attack-Detection-and-Mitigation/Codes/controller/FlowStatsfile.csv","a+")
        body = ev.msg.body
